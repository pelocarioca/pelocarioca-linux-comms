...
"""
Ahora se utiliza un bucle para que se generen normas aleatoriamente
al archivo abierto. Ahora se explicarán las partes de la línea de locals()[...:
...
En conclusión, por cada iteración del bucle se añade una línea en una terminal
con el "resultado" (la norma recién generada) de una de las funciones seed. 
Siendo esta seed elegida aleatoriamente.
"""
while True:
